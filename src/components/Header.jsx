...
import { ChevronDownIcon, CloseIcon, SunIcon, MoonIcon, HomeIcon } from '@/components/Icons';
        ...
        >
          ...
          >
            <div className='flex flex-row-reverse items-center justify-between'>
              ...
              <h2 className='hidden text-sm font-medium text-zinc-600 dark:text-zinc-400' aria-hidden='false'>
                Navigation
              </h2>
            </div>
            <nav className='mt-6'>
